...
public class GameConst {
    ...
    /*
    public static final Map<String, Integer> LV1_CP_MAP = Map.of("min", 10, "max", 100);
    public static final Map<String, Integer> LV2_CP_MAP = Map.of("min", 80, "max", 200);
    public static final Map<String, Integer> LV3_CP_MAP = Map.of("min", 210, "max", 500);
    */
}
